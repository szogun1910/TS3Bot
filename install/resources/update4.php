<?php
	...
	if(preg_match("/\/\/Czy ma zmieniać nazwę kanału i ustawiać liczbę nowych użytkowników 1 - tak 0 - nie.*\],(.*)\/\/Poke/s/\/\/Czy ma zmieniać nazwę kanału i ustawiać liczbę nowych użytkowników 1 - tak 0 - nie.*\],(.*)\/\/Poke/s", $fgc)){
